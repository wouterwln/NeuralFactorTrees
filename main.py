...
if __name__ == "__main__":
    ...
    #gridsearch(args.batch_size, args.training_fraction, args.epochs, args.workers, args.prefetch_factor, args.sampling_fraction, args.seed,
    #           args.learning_rate, args.gpus, args.dropout)
    torch.save(model.state_dict(), args.output_file)
    #model = train(args.batch_size, args.training_fraction, args.epochs, args.workers, args.prefetch_factor, args.sampling_fraction, args.seed, args.hidden_dim, 2,
    #      args.learning_rate, args.gpus, args.dropout)

    #torch.save(model.state_dict(), "gmnn.pt")
