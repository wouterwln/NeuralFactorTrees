...
if __name__ == "__main__":
    ...
    if args.cern:
        train_gmnn_cern(args.batch_size, args.training_fraction, args.epochs, args.workers, args.prefetch_factor, args.sampling_fraction, args.seed, args.hidden_dim, args.num_gnn_steps, args.gpus)
